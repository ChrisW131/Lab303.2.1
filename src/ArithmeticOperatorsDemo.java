...
//DIVISION (/) - divides two values. If we divide a number by 0, it does not have any definitive meaning in arithmetic operations; hence, we will get undefined as a result. (x/y)
//MODULUS (%) - returns the divisor or the reminder (x%Y)
